...
st.markdown('Baseline model should represent preventive maintenance mode, i.e. replacing parts on a usage time basis. Based on historic data we will choose the 25-percentile (to be checked) for remaining tool wear => 50 minutes. ')
size = 500
...
st.markdown('The target of the model is to correctly classify wether there will be a failure, hence it is the target (failure = 1).')
st.write(' ')
st.markdown(
